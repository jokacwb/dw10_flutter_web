...
class PaymentTypeRepositoryImpl implements PaymentTypeRepository {
  ...
  Future<List<PaymentTypeModel>> findAll(bool? enabled) async {
    try {
      ...
      throw RepositoryException(message: 'Erro ao buscar formar de pagamentos');
    }
  }
  ...
  Future<PaymentTypeModel> getById(int id) async {
    try {
      ...
      log(
        'Erro ao buscar forma de pagamentos por id = $id',
        error: e,
        stackTrace: s,
      );
      throw RepositoryException(
        message: 'Erro ao buscar forma de pagamentos por id = $id',
      );
    }
  }
  ...
  Future<void> save(PaymentTypeModel model) async {
    try {
      ...
      log(
        'Erro ao salva forma de pagamentos ${model.name}',
        error: e,
        stackTrace: s,
      );
      throw RepositoryException(
        message: 'Erro ao salva forma de pagamentos ${model.name}',
      );
    }
  }
}
