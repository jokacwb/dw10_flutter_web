...
mixin _$PaymentTypeController on PaymentTypeControllerBase, Store {
  ...
  late final _$_errorMesssageAtom =
      Atom(name: 'PaymentTypeControllerBase._errorMesssage', context: context);

  String? get errorMesssage {
    _$_errorMesssageAtom.reportRead();
    return super._errorMesssage;
  }

  @override
  String? get _errorMesssage => errorMesssage;

  @override
  set _errorMesssage(String? value) {
    _$_errorMesssageAtom.reportWrite(value, super._errorMesssage, () {
      super._errorMesssage = value;
    });
  }
  ...
  Future<void> savePayment(
    ...
    return _$savePaymentAsyncAction.run(() =>
        super.savePayment(id: id, name: name, sigla: sigla, ativo: ativo));
  }
